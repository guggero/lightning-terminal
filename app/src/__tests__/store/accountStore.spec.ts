...
describe('AccountStore', () => {
  ...
  it('should list accounts', async () => {
    ...
    expect(store.accounts.size).toBe(llmListAccounts.accountsList.length);
  });
  ...
  it('should update existing accounts with the same id', async () => {
    ...
    await store.fetchAccounts();
    expect(store.accounts.size).toEqual(llmListAccounts.accountsList.length);
  ...
  it('should close an Account', async () => {
    ...
    expect(txid).toEqual(llmCloseAccount.closeTxid);
  });
  ...
  it('should deposit funds into an account', async () => {
    ...
    expect(+store.activeAccount.totalBalance).toBe(llmDepositAccount.account?.value);
    expect(txid).toEqual(llmDepositAccount.depositTxid);
  });
